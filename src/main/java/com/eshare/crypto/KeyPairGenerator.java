...
public interface KeyPairGenerator {
   ...
   */
  boolean generateKeyPair(String userId, String password, OutputStream publicKey,
   ...
   * @return true if the generation was successful
   */
  boolean generateKeyPair(String userId, String password, int keySize, OutputStream publicKey,
      OutputStream secrectKey);
