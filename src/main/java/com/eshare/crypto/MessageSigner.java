...
public interface MessageSigner {
   ...
   */
  boolean verifyMessage(InputStream publicKeyOfSender, InputStream message,
   ...
   */
  boolean signMessage(InputStream privateKeyOfSender, String userIdForPrivateKey,
      String passwordOfPrivateKey, InputStream message, OutputStream signature);
