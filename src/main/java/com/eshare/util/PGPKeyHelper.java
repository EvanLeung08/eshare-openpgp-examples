...
public class PGPKeyHelper {
  ...
  public static PGPPublicKey readPublicKey(InputStream is) throws IOException, PGPException {
    PGPPublicKeyRingCollection pgpPub =
        new PGPPublicKeyRingCollection(PGPUtil.getDecoderStream(is),
  ...
  private static PGPSecretKey readSecretKey(InputStream is) throws IOException, PGPException {
    PGPSecretKeyRingCollection pgpSec =
        new PGPSecretKeyRingCollection(PGPUtil.getDecoderStream(is),
            new JcaKeyFingerprintCalculator());
  ...
  public static PGPPrivateKey readPrivateKey(InputStream is, String password)
  ...
  public static PGPPrivateKey readPrivateKey(String filePath, String password)
      throws PGPException, IOException {
